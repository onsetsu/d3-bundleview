...
export class Bundleview {
    ...
    constructor(input, selector) {
        ...
        var sizeMetrics = {
            size: function(d) { return d.attributes.size; },
            count: function() { return 1; },
            LengthOfFileName: function(d) { return d.label.length; }
        };

        var partition = d3.layout.partition()
            .sort(null)
            .size([2 * Math.PI, 1])
            .value(sizeMetrics.count);
        ...
        function sizeMetricChanged() {
            var value = sizeMetrics[this.value];
