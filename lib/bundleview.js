    ...
    constructor(input, selector) {
        ...
        function sizeMetricChanged(value) {
            ...
            path
                ...
                .call(colorStyleTween, "fill", currentColorMetric);
        ...
        rootContainer.append("form").selectAll('label')
            .html('Metrics')
        ...
        function colorMetricChanged(scale) {
            ...
            path.transition()
                .duration(750)
                .call(colorStyleTween, "fill", scale);
        }
        ...
        //var hiddenArc = d3.svg.arc()
            ...
            //.startAngle(d => x(/*lowerHalf(d) ? d.x + d.dx :*/ d.x))
            //.endAngle(d => x(/*lowerHalf(d) ? d.x :*/ d.x + d.dx))
            //.innerRadius(getArcMiddleRadius)
            //.outerRadius(getArcMiddleRadius);

        //var hiddenLine = d3.svg.line.radial()
            //.angle(d => x(d.x))
            //.radius(getArcMiddleRadius);
        ...
        var hierarchicalEdgeBundleEnterElementGroup = enterElem.append("g")
            // TODO: we can define our tooltip here!
            //.classed('foobat', true)
        ...
        applyTooltipOn(hierarchicalEdgeBundleEnterElementGroup);
