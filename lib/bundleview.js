...
export class Bundleview {
    ...
    constructor(input, selector) {
        ...
        let currentSizeMetric = sizeMetrics.default;
        ...
        rootContainer.append("form").selectAll('label')
            ...
            .attr('name', 'mode')
            .attr('value', d => d)
            .property('checked', (d, i) => d === 'default')
            .on('change', function() {
        ...
        function getColorMetricsFor(node) {
            var leaf = randomLeaf(node);
            var metrics = { default: d => isLeaf(d) ?
        ...
        let currentColorMetric = colorMetrics.default;
