        ...
        function getColorMetricsFor(node) {
            ...
            Object.keys(leaf.attributes).forEach(attributeName => {
                ...
                if(useLinearColorScale) {
                    ...
                    metrics[attributeName] = d => linearColorScale(d.attributes[attributeName]);
                } else {
                    // categorical scale
                    let values = new Set();
                    walkTree(root, node => {
                    ...
                    metrics[attributeName] = d => ordinalColorScale(d.attributes[attributeName]);
                }
            });
            return metrics;
        }
